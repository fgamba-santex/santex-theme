<?php get_header(); ?>
    ...
    <div class="container-fluid black page-featured blog-featured" style="background-image:url(<?php if (function_exists('z_taxonomy_image_url')) echo z_taxonomy_image_url(); ?>)">
        <div class="container">
    ...
    <div id="primary" class="container new-blog">
        <div class="row">
            ...
            <div class="col-9 new-blog-posts">
                ...
                <h1 class="new-blog-section-title"><?php single_cat_title(); ?></h1>
